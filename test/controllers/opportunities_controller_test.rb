...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference("Opportunity.count") do
      post opportunities_url, params: { opportunity: { description: @opportunity.description, due: @opportunity.due, name: @opportunity.name, type: @opportunity.type } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { description: @opportunity.description, due: @opportunity.due, name: @opportunity.name, type: @opportunity.type } }
